...
6. Route gate or QA failures back to the responsible Developer. Resume that Developer when possible; otherwise select Luna for bounded fixes or Terra for uncertain fixes. Review every correction commit, including fixes within previously reviewed scope.
