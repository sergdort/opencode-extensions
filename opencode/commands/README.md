...
`plan-feature.md`, `decompose.md`, and `start-work.md` require the Architect package, including its `developer` subagent. They intentionally run under the persistent `architect` primary agent.
