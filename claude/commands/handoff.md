...
argument-hint: [next-session focus or scope]
---
...
- Include a `Suggested Skills` section in every handoff with specific Claude Code skills or slash commands the next agent should invoke and why (for example `/plan-feature`, `/decompose`, `/start-work`, or an available skill).
