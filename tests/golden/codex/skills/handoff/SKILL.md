---
name: handoff
description: Use only when the user explicitly invokes $handoff. Create
  repo-local handoff documents for a fresh agent
---
Run this skill only on explicit user invocation.
